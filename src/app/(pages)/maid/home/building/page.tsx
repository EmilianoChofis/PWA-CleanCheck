...
import { changeStatusRoom, getBuildingsByStatus } from '@/app/utils/building-service';
...
export default function Building() {
    ...
    const response = await getBuildingsByStatus(clickedCategory);
			...
			<div className='col-span-1'>
				...
				<RegisterCleaningRoom
					data={{
						...
						onMarkClean: () =>
							roomSelected && handleMarkClean(roomSelected),
